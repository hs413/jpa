...
import jpa.springboot.domain.Address;
import jpa.springboot.domain.Member;
import jpa.springboot.domain.Order;
import jpa.springboot.domain.OrderStatus;
import jpa.springboot.domain.item.Book;
import jpa.springboot.domain.item.Item;
import jpa.springboot.exception.NotEnoughStockException;
import jpa.springboot.repository.OrderRepository;
